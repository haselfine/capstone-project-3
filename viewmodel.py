...
class ViewModel:
    ...
    def add_artist(self, name_in, email_in):
        Artist.create(artist_name=name_in, email=email_in)

    def add_artwork(self, artist_name_in, artwork_name_in, price_in, available_in):
        Artwork.create(artist_name=artist_name_in, artwork_name=artwork_name_in, price=price_in, available=available_in)
